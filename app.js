...
var incompleteTaskHolder=document.getElementById("menu__incomplete-tasks");//ul of #menu__incomplete-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="menu__item-input";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="menu__button button_edit";

    deleteButton.className="menu__button button_delete";
    deleteButtonImg.src='./remove.svg';
    deleteButtonImg.className = "menu__delete-button-img"
